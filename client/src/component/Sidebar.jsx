...
import { Eraser, FileText, Hash, SquarePen, Users, Image, House, LogOut } from "lucide-react";
...
const navItems = [
  ...
  { to: "/ai/genrate-images", label: "Generate Images", Icon: Image },
  ...
  return (
    ...
    >
      <div className="my-7 w-full">
        ...
        <div className="px-6 mt-5 text-sm text-gray-600 font-medium"></div>
      ...
      <div className="w-full border-t border-gray-200 p-4 px-7 flex items-center justify-between">
        ...
        <LogOut
          onClick={signOut}
          className="w-5 text-gray-400 hover:text-gray-700 transition cursor-pointer"  // ✅ FIXED (w-4.5 removed)
        />
      </div>
    </div>
  );
